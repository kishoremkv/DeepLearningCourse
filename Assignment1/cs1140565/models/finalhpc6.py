...
# train_data2 = ImageFolder(root='data/train', transform=my_transform1 )
# train_data3 = ImageFolder(root='data/train', transform=my_transform1 )
# train_data4 = ImageFolder(root='data/train', transform=my_transform1 )
...
'''
train_loader3 = torch.utils.data.DataLoader(dataset=train_data3, 
                                           batch_size=batch_size, 
                                           shuffle=True)

train_loader4 = torch.utils.data.DataLoader(dataset=train_data4, 
                                           batch_size=batch_size, 
                                           shuffle=True)
...
'''
def checkvalidationerror(c_epoch):
    correct = 0
    total = 0
...
torch.save(model.state_dict(), 'newmodel6.pt')

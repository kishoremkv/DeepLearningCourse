...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.relu1 = nn.ReLU()
        self.maxpool1 = nn.MaxPool2d(kernel_size=2,stride=2,ceil_mode=False)
        self.cnn2 = nn.Conv2d(in_channels=96, out_channels=256, kernel_size=5, stride=1, padding=2,groups=2)
        self.relu2 = nn.ReLU()
        self.maxpool2 = nn.MaxPool2d(kernel_size=2,stride=2,ceil_mode=False)
        ...
        self.relu5 = nn.ReLU()
        self.maxpool5 = nn.MaxPool2d(kernel_size=2,stride=2,ceil_mode=False)
        self.fc6 = nn.Linear(256 * 7 * 7, 256) 
        self.relu6 = nn.ReLU()
...
torch.save(model.state_dict(), 'newmodel5.pt')
